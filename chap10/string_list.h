...
// this sets the values for the iterators by allocating memory to the object equal to the size of the array
...
template <class T> T car(const list<T>& l) { // returns the initial character of the list member, which also acts as a pointer to the object
